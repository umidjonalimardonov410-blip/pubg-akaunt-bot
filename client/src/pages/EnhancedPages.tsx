...
export function ChatPage({ id, onBack }: { id: number; onBack: () => void }) {
  ...
  if (!isAuthenticated) return <main className="mx-auto max-w-2xl rounded-3xl border border-amber-400/20 bg-[#0e1013] p-8 text-center"><MessageCircle className="mx-auto h-10 w-10 text-amber-200" /><h1 className="mt-4 font-display text-2xl font-black text-white">Xavfsiz chat</h1><p className="mt-2 text-sm text-white/45">Sotuvchi bilan yozishish uchun tizimga kiring.</p></main>;
...
export function ReferralPage() {
  ...
  if (!isAuthenticated) return <main className="mx-auto max-w-2xl rounded-3xl border border-amber-400/20 bg-[#0e1013] p-8 text-center"><Star className="mx-auto h-10 w-10 text-amber-200" /><h1 className="mt-4 font-display text-2xl font-black text-white">Referral dasturi</h1><p className="mt-2 text-sm text-white/45">Do‘stlaringizni taklif qilish va bonus olish uchun tizimga kiring.</p></main>;
